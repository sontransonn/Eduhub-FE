    ...
    return (
        <>
            ...
            <div className="flex flex-1 flex-col gap-4 p-4">
                <div className='flex scrollable flex-1 flex-col gap-4 max-h-[450px] overflow-scroll'>
                    {Array.from({ length: 2 }).map((_, index) => (
                        <div className='flex' key={index}>
                            <div className='md:basis-3/4 flex gap-2.5 items-center'>
                                <img src="https://cf.quizizz.com/img/logos/new/logo_placeholder_sm.webp?w=200&h=200" alt="" className='w-24 rounded-sm bg-red-700' />
                                <div className='flex flex-col self-stretch justify-between'>
                                    ...
                                    <h3 className='font-semibold'>React cơ bản cho người mới bắt đầu</h3>
