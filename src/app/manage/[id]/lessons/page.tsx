                        ...
                        {listLesson.map((lesson: { lessonName: string, lessonContent: string }, index) => (
                            <div className='flex' key={index}>
                                <div className='md:basis-3/4 flex gap-2.5 items-center'>
                                    <img src="https://i.ytimg.com/vi/ml5sNqftiK4/hqdefault.jpg?sqp=-oaymwEmCKgBEF5IWvKriqkDGQgBFQAAiEIYAdgBAeIBCggYEAIYBjgBQAE=&rs=AOn4CLCbU92_R-WyNN97qHqtnPo3Yr-XWg" alt="" className='w-40 rounded-sm' />
