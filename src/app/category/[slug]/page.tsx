...
export default function CourseSlug() {
    ...
    return (
        <main className='bg-[#F1F5F8] text-black'>
            <div className='max-w-8xl mx-auto px-4 xl:px-20 lg:px-10 md:px-10 lg:py-14 py-8 flex flex-col gap-8'>
                <div className='flex flex-col gap-5'>
                    <div className='w-full'>
                        <h3 className='xl:text-[32px] text-[26px] font-medium text-black'>Khóa học Tin Học Văn Phòng</h3>
                ...
                <div className='grid lg:grid-cols-4 grid-cols-1 gap-4'>
                    ...
                    <div className={`lg:col-span-3 ${!isFilter && "lg:col-span-4"} flex flex-col gap-6`}>
                        {Array.from({ length: 8 }).map((_, index) => (
