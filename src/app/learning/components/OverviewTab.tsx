...
export default function OverviewTab({ avatar, introduce }: { avatar: string, introduce: string }) {
    return (
        <>
                ...
                <div className='col-span-5 ms-3 lg:ms-0'>
                    ...
                    <div className='flex gap-6 mb-4'>
                        <div className='rounded-full border-2 border-solid border-white'>
                            <img src={avatar} alt="" className='object-cover w-[117px] h-[117px] rounded-full' />
                        </div>
