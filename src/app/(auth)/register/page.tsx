        ...
        <div className="w-full lg:w-1/2 xl:w-1/3">
            <div className="relative flex flex-col min-w-0 break-words w-full shadow-lg rounded-lg bg-gray-200 border-0">
                <div className="flex-auto px-4 pt-6">
                    {/* tiêu đề */}
                    <h1 className="text-lg text-center font-bold uppercase">Đăng ký</h1>
                    <div className="mb-2"></div>

                    {/* form đăng ký */}
                    <form action="" className="text-sm">
                        <div className='relative w-full mb-3'>
                            <label className='block uppercase text-gray-700 text-xs font-bold mb-2' htmlFor="">Họ tên</label>
                        ...
                        <div className='relative w-full mb-3'>
                            <label className='block uppercase text-gray-700 text-xs font-bold mb-2' htmlFor="">Email</label>
                            <div className='flex gap-2'>
                                <input
                                    type="email"
                                    className='w-full p-3 rounded-md border border-blue-500 outline-none'
                        ...
                        <div className='relative w-full mb-3'>
                            <label className='block uppercase text-gray-700 text-xs font-bold mb-2' htmlFor="">Số điện thoại</label>
                            <div className='flex gap-2'>
                                <input
                                    type="text"
                                    className='w-full p-3 rounded-md border border-blue-500 outline-none'
                        ...
                        <div className="flex gap-3">
                            ...
                            <div className="w-full">
                                <label className='block uppercase text-gray-700 text-xs font-bold mb-2' htmlFor="">Nhập lại mật khẩu</label>
                                <input
                                    type="text"
                                    className='w-full p-3 rounded-md border border-blue-500 outline-none'
                                    placeholder="Mật khẩu"
                    ...
                    <div className='flex justify-between mt-6 text-[13px] text-blue-600'>
                        ...
                        <span className='cursor-pointer' onClick={() => handleRedirect("/login")}>Đăng nhập</span>
                    </div>
