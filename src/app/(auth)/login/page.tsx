...
const LoginPage = () => {
    ...
    return (
        <div className="w-full lg:w-1/2 xl:w-1/3">
            <div className="relative flex flex-col min-w-0 break-words w-full shadow-lg rounded-lg bg-gray-200 border-0 flex-auto px-4 pt-6">
                {/* Tiêu đề */}
                <h1 className="text-lg text-center font-bold uppercase mb-2">Đăng nhập</h1>
                ...
                <div className="text-sm">
                    ...
                    <div className='mt-6 text-center'>
                        <button
                            className='bg-blue-500 hover:bg-blue-600 w-full py-3 px-6 text-white font-bold rounded-md'
                ...
                <div className='flex justify-between mt-6 text-[13px] text-blue-600'>
                    <a href="/forgot-password" className='cursor-pointer'>Quên mật khẩu?</a>
                    <a href="/register" className='cursor-pointer'>Đăng ký</a>
                </div>
